...
<body>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    aria-hidden="true" background-color: #111;>
   ...
   <a  href="certificate/certificate.php">CERTIFICATE </a>
...
<!-- Navigation bar end  -->
  ...
  <button class="btn btn-primary" style="background-color:black; border: black solid; "type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
  <i class="fa fa-plus"></i> Add New Card
  </button>
  <a href="id-card.php" class="btn btn-primary" style="background-color:black; border: black solid;">
  <i class="fa fa-address-card" style="background-color:black; border: black solid;"></i> Generate
</a>
</p>
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <div class="form-row">
      ...
      <button type="submit" class="btn btn-primary" style="background-color: black;"><i class="fa fa-plus"></i> Add Card</button>
    </form>
  </div>
</div>
